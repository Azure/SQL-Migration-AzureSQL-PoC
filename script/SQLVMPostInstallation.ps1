...
try {
    ...
    Invoke-Sqlcmd -ServerInstance "localhost" -Database master -Username $userName -Password $userPassword -Query "RESTORE DATABASE [AdventureWorks2019] FROM DISK = N'C:\temp\backup\AdventureWorks2019.bak' WITH FILE = 1 , MOVE N'AdventureWorks2019'  TO N'F:\SQLData\AdventureWorks2019.mdf', MOVE N'AdventureWorks2019_log' TO N'G:\SQLLog\AdventureWorks2019_log.ldf', NOUNLOAD, STATS = 5;" -TrustServerCertificate
    Invoke-Sqlcmd -ServerInstance "localhost" -Database master -Username $userName -Password $userPassword -Query "RESTORE DATABASE [AdventureWorks_with_issues] FROM DISK = N'C:\temp\backup\AdventureWorks2019.bak' WITH FILE = 1 , MOVE N'AdventureWorks2019'  TO N'F:\SQLData\AdventureWorks_with_issues.mdf', MOVE N'AdventureWorks2019_log' TO N'G:\SQLLog\AdventureWorks_with_issues.ldf', NOUNLOAD, STATS = 5;" -TrustServerCertificate
    Invoke-Sqlcmd -ServerInstance "localhost" -Database master -Username $userName -Password $userPassword -Query "RESTORE DATABASE [AdventureWorksTDE] FROM DISK = N'C:\temp\backup\AdventureWorks2019.bak' WITH FILE = 1 , MOVE N'AdventureWorks2019'  TO N'F:\SQLData\AdventureWorksTDE.mdf', MOVE N'AdventureWorks2019_log' TO N'G:\SQLLog\AdventureWorksTDE.ldf', NOUNLOAD, STATS = 5;" -TrustServerCertificate
...
try {
    ...
    Invoke-Sqlcmd -ServerInstance "localhost" -Database master -Username $userName -Password $userPassword -Query "BACKUP CERTIFICATE TDEServerCert TO FILE = 'C:\temp\backup\TDEServerCert'" -TrustServerCertificate
